  ...
  render() {
    return (
      <div className="footer">
        ...
        <div align="center" className="footer-element">
          <img src={reactLogo} className="App-logo" id="reactLogo" />
          Built using React.{" "}
        </div>
      </div>
    );
